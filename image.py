...
def blur_offensive_images(data):
    ...
    result = vision_client.logo_detection(image=blob_source)
    logos = result.logo_annotations
    ...
    if logos:
        ...
        print(f"The image {file_name} was detected without logos.")
...
def __blur_image(current_blob):
    ...
    blur_file_name = "blurred-" + file_name
    ...
    new_blob = blur_bucket.blob(blur_file_name)
    new_blob.upload_from_filename(temp_local_filename)
    print(
        f"Blurred image uploaded to: gs://{blur_bucket_name}/{blur_file_name}")
